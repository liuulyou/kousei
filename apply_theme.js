...
const CHARACTERS = {
  char1: { label: "디아토비라 텐카", account: "@SolDoFaZizK_dame", side: "left", colorLight: "#2f6690", colorDark: "#7fbbe8" },
  char2: { label: "안야 코우세이", account: "@astra_dame", side: "right", colorLight: "#8c4a63", colorDark: "#dd93ab" },
};
